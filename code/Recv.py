...
class Recv(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Recv")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Recv")
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/cascades/play_with_ask/data/bin/Recv.bin', False)
    ...
    def set_center_freq(self, center_freq):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq, 10e6)



def main(top_block_cls=Recv, options=None):
